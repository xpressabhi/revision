...
const THEMES: { id: ThemeId; name: string; sub: string; swatches: string[]; fg: string }[] = [
  { id: "dark-a", name: "Slate & Emerald", sub: "dark · Raycast/Linear", swatches: ["#0e0e12", "#1e1e26", "#3be28b"], fg: "#f5f5f7" },
  { id: "light-a", name: "Slate & Emerald", sub: "light", swatches: ["#f5f5f7", "#ffffff", "#0e9f6e"], fg: "#18181b" },
  { id: "dark-b", name: "OLED & Amber", sub: "dark · Superhuman/Arc", swatches: ["#0b0908", "#211b15", "#ffa233"], fg: "#f8f4ec" },
  { id: "light-b", name: "OLED & Amber", sub: "light", swatches: ["#fbf6ef", "#fffefc", "#d97706"], fg: "#241d14" },
];
    ...
    <div className="canvas-inner">
      ...
      <div className="settings-grid">
        ...
        <div className="set-card">
          ...
          <p>Free Spaced Repetition Scheduler — R(t) = (1 + 19/81·t/S)^−0.5 with FSRS-5 weights. Lower target retention = longer intervals and lighter load.</p>
          <div className="set-row">
        ...
        <div className="set-card">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <p style={{ fontSize: 11 }}>Adds 37 cards across Spanish, Biology, DSA and System Design — plus ~90 days of review history for the heatmap. Deterministic, safe to re-run.</p>
