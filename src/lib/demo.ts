...
const DEMO_CARDS: DemoCard[] = [
  ...
  { tags: "sd>distributed", front: "URL shortener scale: how many rows in 5 years?", back: "~100M URLs/day to ~100B rows to ~5TB metadata. Base62 vs 7-char random." },
  ...
  { tags: "sd>distributed", front: "$QPS = \\frac{100 \\times 10^6}{86400}$: why does this matter in capacity planning?", back: "About 1,157 QPS average with peak 3 to 4x that. Capacity must target peak, not average." },
